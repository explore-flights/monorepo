...
export class CloudfrontUtil {
  ...
  public static addCloudfrontOACToLambdaResourcePolicy(functionUrl: IFunctionUrl, distribution: IDistribution) {
    functionUrl.grantInvokeUrl(new ServicePrincipal('cloudfront.amazonaws.com', {
      conditions: {
        ArnLike: {
          'aws:SourceArn': CloudfrontUtil.distributionArn(distribution),
        },
      },
    }));
  }
