...
SELECT
    ...
    COALESCE(TRY_CAST(REGEXP_EXTRACT(SPLIT_PART(aircraftConfigurationVersion, 'VV', 1), '(E|R|U|P|PY|O|S)([0-9]+)', 2) AS USMALLINT), 0) AS seatsPremium,
...
WHERE seatCode NOT IN ('F', 'C', 'J', 'W', 'E', 'R', 'U', 'P', 'PY', 'O', 'S', 'M', 'Y') ;
